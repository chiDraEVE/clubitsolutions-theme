...
/**
 * Title: 404
 * Slug: clubitsolutions-theme/404
 * Categories: text
 * inserter: no
 *
...
<h2 class="has-text-align-center has-x-large-font-size"><?php esc_html_e( 'Page not found', 'clubitsolutions-theme' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try a search?', 'clubitsolutions-theme' ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="has-text-align-left"><?php esc_html_e( 'Latest posts', 'clubitsolutions-theme' ); ?></h2>
<!-- /wp:heading -->
