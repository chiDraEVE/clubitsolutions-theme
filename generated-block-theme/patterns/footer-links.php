...
/**
 * Title: Footer links
 * Slug: clubitsolutions-theme/footer-links
 * Categories: text
 * Inserter: no
 *
...
<p class="has-extra-small-font-size"><?php esc_html_e( 'Copyright', 'clubitsolutions-theme' );
echo ' ' . date_i18n( _x( 'Y', 'copyright date format', 'clubitsolutions-theme' ) ); ?></p><!-- /wp:paragraph -->
<!-- wp:site-title {"level":0, "fontSize":"extra-small"} /-->
<?php echo clubitsolutions_theme_privacy(); ?>
